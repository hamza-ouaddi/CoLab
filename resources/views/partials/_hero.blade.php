<section class=" md:h-[610px] bg-gradient-to-br from-lightBlue2 to-lightBlue flex items-center justify-center rounded-[32px] md:p-10 p-6 ">
    ...
    <div class=" flex md:flex-row flex-col-reverse justify-center items-center gap-14">
        <div class="md:w-[45%]">
            ...
            <a href="/register" class="inline-block bg-gradient-to-br from-blue to-purple text-white md:py-5 py-4 md:px-8 px-6 mt-6 rounded-2xl md:text-lg text-sm md:font-medium font-normal leading-6 hover:shadow-lg hover:shadow-blue/50 duration-500 ease-in-out">Sign up to list an Offer</a>
        </div>
        <div class="">
            <img src="{{ asset('images/hero-picture.png') }}" alt="hero-picture">
        </div>
    </div>  
</section>